 ...
 */
 ...
 class PhotonCalibration : public marlin::Processor {

 public:

 virtual marlin::Processor*  newProcessor() { return new PhotonCalibration ; }
...
int nrejected;
  ...
  double _allowedThetaDeviation;
  double _allowedPhiDeviation;
